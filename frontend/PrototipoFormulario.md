    ...
    <div class="right-section">
      <div class="form-container">
        ...
        <form @submit.prevent="submitForm">
          ...
          <label for="fotos">Subir 3 Fotos</label>
...
export default {
  ...
  methods: {
    ...
    async submitForm() {
  try {
    // Mostrar la alerta de "enviando" inmediatamente, sin esperar la respuesta del servidor
    Swal.fire({
      title: 'Enviando...',
    ...
    // Enviar el formulario al backend con Axios
    const response = await axios.post('https://dia-nacional-cepillado-sbfb2024.col1.co/backend/api/forms', formData, {
      headers: {
        'Content-Type': 'multipart/form-data',
      },
    });

    // Actualizar la alerta para mostrar éxito cuando la solicitud se complete
    Swal.fire({
